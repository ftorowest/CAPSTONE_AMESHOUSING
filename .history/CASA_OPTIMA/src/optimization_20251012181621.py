...
def optimize_house(
    ...
    room = {
        ...
        "Second_Flr_SF":      M_,  # pies² adicionales en segundo piso
        "Year_Built":           0,  
    ...
    m.addConstr( x["First_Flr_SF"] >= x["Full_Bath"] * baño_promedio + x["Kitchen_AbvGr"] * cocina_promedio + x["TotRms_AbvGrd"] * habitacion_promedio , name="sf_min")
