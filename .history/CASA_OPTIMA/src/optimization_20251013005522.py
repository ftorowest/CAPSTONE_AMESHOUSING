...
def optimize_house(
    ...
    default_costs = {
        "First_Flr_SF":        80,   # costo por pie² en el primer piso
        "Second_Flr_SF":       70,   # segundo piso es más caro estructuralmente
    ...
    min_delta = {"First_Flr_SF": 40, "Second_Flr_SF": 40, "Total_Bsmt_SF": 20, "Pool_Area": 10}
