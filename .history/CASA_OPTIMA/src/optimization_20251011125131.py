...
def optimize_house(
    ...
    # rimer piso mas garage no puede superar el area del lote
    ...
    #Las ampliaciones en SF deben ser significativas (No de 1 pie²)
    ...
    for v, min_d in min_delta.items():
        ...
        m.addConstr(x[v] - baseline[v] <= M_grande * ampliaciones[v], name=f"{v}_activacion_A")
