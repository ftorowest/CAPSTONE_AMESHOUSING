...
def optimize_house(
    ...
    default_costs = {
        ...
        "Exter_Qual":          500,  # mejorar calidad exterior
        ...
        "Garage_Finish":       3000,
        "Garage_Qual":         6000,
        "Kitchen_Qual":        124 * ,  # mejorar calidad de cocina (por nivel)
    ...
    # Atributos asociados al basement
    ...
    #20. Garage debe tener sus atributos asociados distintos de 0
